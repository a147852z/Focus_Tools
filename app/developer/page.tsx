...
const assets: FurnitureAsset[] = [
  ...
  { id: "wallPanel", name: "森林木牆", src: "/assets/furniture/wall-panel-game.png", width: 53, mobileWidth: 70, anchorX: 50.33, anchorY: 106.81, flipOriginX: 50.88, flipOriginY: 97.27, footprintX: 1, footprintY: 1 },
];
